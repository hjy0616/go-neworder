...
// Package ethclient provides a client for the Neworder RPC API.
package ethclient
...
// Client defines typed wrappers for the Neworder RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*neworder.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (neworder.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q neworder.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q neworder.FilterQuery, ch chan<- types.Log) (neworder.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q neworder.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg neworder.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg neworder.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg neworder.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*neworder.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg neworder.CallMsg) (uint64, error) {
...
func toCallArg(msg neworder.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *neworder.SyncProgress {
	if p == nil {
		return nil
	}
	return &neworder.SyncProgress{
