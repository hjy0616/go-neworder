...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gnod.ipc", false, filepath.Join(os.TempDir(), "gnod.ipc")},
		{"data", "gnod.ipc", false, "data/gnod.ipc"},
		{"data", "./gnod.ipc", false, "./gnod.ipc"},
		{"data", "/gnod.ipc", false, "/gnod.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gnod.ipc", true, `\\.\pipe\gnod.ipc`},
		{"data", "gnod.ipc", true, `\\.\pipe\gnod.ipc`},
		{"data", `\\.\pipe\gnod.ipc`, true, `\\.\pipe\gnod.ipc`},
	}
