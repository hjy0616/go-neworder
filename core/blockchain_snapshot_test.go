...
// It can be used for testing that restart Gnod normally.
...
// It can be used for testing that restart Gnod after the crash.
...
// Tests a Gnod restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gnod was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gnod was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gnod was running with snapshot enabled. Then restarts without
...
// Tests the Gnod was running with snapshot enabled and resetHead is applied.
...
// Tests the Gnod was running with a complete snapshot and then imports a few
