...
// Package state provides a caching layer atop the Neworder state trie.
package state
...
// StateDB structs within the neworder protocol are used to store anything
...
//
// Carrying over the balance ensures that Nod doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/neworder-network/go-neworder/pull/16485#issuecomment-380438527),
