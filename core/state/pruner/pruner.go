...
pruning. Remember don't start the Gnod without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gnod snapshot prune-state --help" for more details.
`
