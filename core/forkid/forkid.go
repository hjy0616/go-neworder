...
// NewID calculates the Neworder fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Neworder fork ID from an existing chain instance.
