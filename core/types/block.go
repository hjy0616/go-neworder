...
// Package types contains data types related to Neworder consensus.
package types
...
// Header represents a block header in the Neworder blockchain.
type Header struct {
...
// Block represents an entire block in the Neworder blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the Neworder
...
// EncodeRLP serializes b into the Neworder RLP block format.
