...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain neworder.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to neworder-type signature.
		signature[64] -= 27 // Transform V from Neworder-legacy to 0/1
	}
