...
// Package bind generates Neworder contract Go bindings.
//
// Detailed usage document and tutorial available on the go-neworder Wiki page:
// https://github.com/neworder-network/go-neworder/wiki/Native-DApps:-Go-bindings-to-Neworder-contracts
package bind
