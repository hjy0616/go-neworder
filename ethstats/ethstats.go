...
import (
	...
	ethproto "github.com/neworder-network/go-neworder/eth/protocols/eth"
...
type backend interface {
	...
	SyncProgress() neworder.SyncProgress
}
...
// Service implements an Neworder netstats reporting daemon that pushes local
