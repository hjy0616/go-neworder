...
// Syncing provides information when this nodes starts synchronising with the Neworder network and when it's finished.
...
type SyncingResult struct {
	...
	Status  neworder.SyncProgress `json:"status"`
}
