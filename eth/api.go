...
// NeworderAPI provides an API to access Neworder full node-related information.
type NeworderAPI struct {
	e *Neworder
}

// NewNeworderAPI creates a new Neworder protocol API for full nodes.
func NewNeworderAPI(e *Neworder) *NeworderAPI {
	return &NeworderAPI{e}
}

// Etherbase is the address that mining rewards will be send to.
func (api *NeworderAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase).
func (api *NeworderAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate.
func (api *NeworderAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *NeworderAPI) Mining() bool {
...
func NewMinerAPI(e *Neworder) *MinerAPI {
	return &MinerAPI{e}
}
...
// AdminAPI is the collection of Neworder full node related APIs for node
// administration.
...
func NewAdminAPI(eth *Neworder) *AdminAPI {
...
// DebugAPI is the collection of Neworder full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *Neworder) *DebugAPI {
