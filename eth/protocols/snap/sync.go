...
import (
	...
	"github.com/neworder-network/go-neworder/p2p/msgrate"
...
// Syncer is an Neworder account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Neworder state over the
// snap protocol.
