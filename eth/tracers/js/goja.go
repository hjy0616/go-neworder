...
import (
	...
	jsassets "github.com/neworder-network/go-neworder/eth/tracers/js/internal/tracers"
)

var assetTracers = make(map[string]string)

// init retrieves the JavaScript transaction tracers included in go-neworder.
func init() {
	var err error
