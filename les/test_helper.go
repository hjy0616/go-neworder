...
import (
	...
	"github.com/neworder-network/go-neworder/accounts/abi/bind/backends"
	...
	"github.com/neworder-network/go-neworder/contracts/checkpointoracle/contract"
	"github.com/neworder-network/go-neworder/core"
	"github.com/neworder-network/go-neworder/core/forkid"
	...
	"github.com/neworder-network/go-neworder/les/checkpointoracle"
	"github.com/neworder-network/go-neworder/les/flowcontrol"
	vfs "github.com/neworder-network/go-neworder/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some nod to user1
		...
		case 1:
			...
			// bankUser transfers more nod to user1
		...
		case 2:
			...
			// bankUser transfer some nod to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
