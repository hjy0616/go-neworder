...
import (
	...
	"github.com/neworder-network/go-neworder/common/bitutil"
	"github.com/neworder-network/go-neworder/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Neworder
...
func (eth *LightNeworder) startBloomHandlers(sectionSize uint64) {
