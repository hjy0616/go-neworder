...
import (
	...
	ethdownloader "github.com/neworder-network/go-neworder/eth/downloader"
	...
	"github.com/neworder-network/go-neworder/p2p/simulations"
	"github.com/neworder-network/go-neworder/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	neworder, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, neworder, &config)
	if err != nil {
		return nil, err
	}
	return neworder, nil
