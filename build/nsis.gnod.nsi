...
# 1. install gnod for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gnod
# 5. create gnod, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable NEWORDER_SOCKET
...
!define GROUPNAME "Neworder"
!define APPNAME "Gnod"
!define DESCRIPTION "Official Go implementation of the Neworder protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gnod is installed global
