Name "gnod ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/neworder-network/go-neworder/issues"
!define UPDATEURL "https://github.com/neworder-network/go-neworder/releases"
!define ABOUTURL "https://github.com/neworder-network/go-neworder#neworder-go"
...
# Install gnod binary
Section "Gnod" GNOD_IDX
  SetOutPath $INSTDIR
  file {{.Gnod}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gnod.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gnod.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gnod incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gnod outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gnod UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gnod incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gnod.exe" "" "" "Neworder" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gnod outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gnod.exe" "" "" "Neworder" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gnod UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gnod.exe" "" "" "Neworder" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "NEWORDER_SOCKET" "R" "HKLM" "\\.\pipe\gnod.ipc"
  ${EnvVarUpdate} $0 "NEWORDER_SOCKET" "A" "HKLM" "\\.\pipe\gnod.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GNOD_IDX}
    SectionGetSize ${GNOD_IDX} $0
