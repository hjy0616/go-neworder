...
// This test reproduces https://github.com/neworder-network/go-neworder/issues/17837 where the
...
// It is the reproducer for https://github.com/neworder-network/go-neworder/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-neworder-test-ipc-%d-%d", os.Getpid(), rand.Int63())
