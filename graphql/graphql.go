...
// Package graphql provides a GraphQL interface to Neworder node data.
package graphql
...
// Account represents an Neworder account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Neworder transaction.
...
// Block represents an Neworder block.
...
type CallData struct {
	From                 *common.Address // The Neworder address the call is from.
	To                   *common.Address // The Neworder address the call is to.
...
type SyncState struct {
	progress neworder.SyncProgress
}
