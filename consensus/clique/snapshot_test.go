...
// mapped from textual names used in the tests below to actual Neworder private
...
// address retrieves the Neworder address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Neworder address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/neworder-network/go-neworder/issues/17593). Whilst this
