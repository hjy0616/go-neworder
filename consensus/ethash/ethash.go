...
// all blocks' seal as valid, though they still have to conform to the Neworder
// consensus rules.
...
// still have to conform to the Neworder consensus rules.
...
// they still have to conform to the Neworder consensus rules.
