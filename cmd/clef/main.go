// Copyright 2018 The go-neworder Authors
...
import (
	...
	"github.com/neworder-network/go-neworder/signer/core"
	"github.com/neworder-network/go-neworder/signer/core/apitypes"
	"github.com/neworder-network/go-neworder/signer/fourbyte"
	"github.com/neworder-network/go-neworder/signer/rules"
	"github.com/neworder-network/go-neworder/signer/storage"
...
var (
	...
	app = flags.NewApp(gitCommit, gitDate, "Manage Neworder account operations")
)
...
func checkFile(filename string) error {
	...
	// https://github.com/neworder-network/go-neworder/issues/20123
...
func testExternalUI(api *core.SignerAPI) {
	...
	{ // Sign data test - typed data
		...
		time.Sleep(delay)
		addr, _ := common.NewMixedcaseAddressFromString("0x0011223344556677889900112233445566778899")
		data := `{"types":{"EIP712Domain":[{"name":"name","type":"string"},{"name":"version","type":"string"},{"name":"chainId","type":"uint256"},{"name":"verifyingContract","type":"address"}],"Person":[{"name":"name","type":"string"},{"name":"test","type":"uint8"},{"name":"wallet","type":"address"}],"Mail":[{"name":"from","type":"Person"},{"name":"to","type":"Person"},{"name":"contents","type":"string"}]},"primaryType":"Mail","domain":{"name":"Nod Mail","version":"1","chainId":"1","verifyingContract":"0xCCCcccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC"},"message":{"from":{"name":"Cow","test":"3","wallet":"0xcD2a3d9F938E13CD947Ec05AbC7FE734Df8DD826"},"to":{"name":"Bob","wallet":"0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB","test":"2"},"contents":"Hello, Bob!"}}`
