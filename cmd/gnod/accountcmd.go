...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Neworder presale wallets",
		ArgsUsage: "",
		Description: `
    gnod wallet import /path/to/my/presale.wallet

will prompt for your password and imports your nod presale account.
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Neworder presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
				...
				Description: `
	gnod wallet [options] /path/to/my/presale.wallet
...
between neworder nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gnod account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gnod account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another neworder instance,
...
func accountCreate(ctx *cli.Context) error {
	cfg := gnodConfig{Node: defaultNodeConfig()}
	// Load config file.
