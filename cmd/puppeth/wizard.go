...
type wizard struct {
	...
	services map[string][]string   // Neworder services known to be running on servers
...
// converts it to an Neworder address. If an empty line is entered, the default
// value is returned.
