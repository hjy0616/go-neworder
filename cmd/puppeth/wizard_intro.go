...
// setting up a new or managing an existing Neworder private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Neworder private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Neworder network down to  |")
	...
	log.Info("Administering Neworder network", "name", w.network)
