...
import (
	...
	"github.com/neworder-network/go-neworder/internal/jsre"
	"github.com/neworder-network/go-neworder/internal/jsre/deps"
	"github.com/neworder-network/go-neworder/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Neworder requests through
...
// Welcome show summary of current Gnod instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gnod JavaScript console!\n\n"

	// Print some generic Gnod metadata
