...
// Package ethapi implements the general Neworder API functions.
package ethapi
...
func GetAPIs(apiBackend Backend) []rpc.API {
	...
	return []rpc.API{
		{
			Namespace: "eth",
			Service:   NewNeworderAPI(apiBackend),
		}, {
			Namespace: "eth",
			...
			Namespace: "eth",
			Service:   NewNeworderAccountAPI(apiBackend.AccountManager()),
		}, {
			Namespace: "personal",
